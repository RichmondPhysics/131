...
\answerspace{0.3cm}
{\par\centering \includegraphics{../../131/StudentGuideModule1/elec_grav/elec_grav_fig3_new.eps} \par}
\answerspace{0.3cm}
...
\vspace{0.3cm}
{\par\centering \includegraphics{../../131/StudentGuideModule1/elec_grav/elec_grav_fig4_new.eps} \par}
\vspace{0.3cm}
