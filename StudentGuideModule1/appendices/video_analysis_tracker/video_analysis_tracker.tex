...
\begin{enumerate}
	\item Start up the Camera application by going to {\bf Start} $\rightarrow$ {\bf Camera}

	\item Click the \textbf{Settings} icon (upper-left corner of the screen)
	...
	\item Click on \textbf{auto} (left side of the screen)
