...
%\vspace{0.3cm}
{\par\centering \includegraphics[scale=0.9]{mom_cons/mom_cons_fig1_new.pdf} \par}
%\vspace{0.3cm}
...
%\vspace{0.3cm}
{\par\raggedright \includegraphics[height=1.8in]{mom_cons/mom_cons_fig2_new.pdf} \par}
%\vspace{0.3cm}
...
%\vspace{0.3cm}
{\par\centering \includegraphics{mom_cons/mom_cons_fig3_new.pdf} \par}
\vspace{1cm}
...
%\vspace{0.3cm}
{\par\centering \includegraphics{mom_cons/mom_cons_fig4_new.pdf} \par}
\vspace{1cm}
...
%\vspace{0.3cm}
{\par\centering \includegraphics{mom_cons/mom_cons_fig5_new.pdf} \par}
\answerspace{1cm}
