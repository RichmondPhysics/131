...
\item Open the file \filename{P\_Graphs.cap} in the \filename{\coursefolder} folder. Turn on the motion sensor at your station and connect it to the computer via Bluetooth.
...
\pagebreak[2]
2. Select ten data points on your graph using the \textbf{Highlight} tool. (See \textbf{Appendix \ref{capstone}}.) Use the scroll wheel to zoom in until the highlighted data points span the graph. Notice that zooming in has the effect of viewing the data over successively shorter time intervals. What does examining the data over successively shorter
