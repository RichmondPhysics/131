...
\begin{figure}[hb]
\includegraphics[height=2.25in]{measurement_uncertainty/histogram_color.pdf}\label{SampleHist1}
\index{color page}
\end{figure}
...
\vspace{0.3cm}
{\par\centering \includegraphics{measurement_uncertainty/measurement_uncertainty_fig1.pdf} \par}
\vspace{0.3cm}
