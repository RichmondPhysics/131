...
\newcommand{\coursesection}{\\Fall 2025\\} %This defines the section (and/or year) for the title page.
...
\includelab{0}{drag_force/drag_force}
...
\includelab{1}{ballistic_pendulum/ballistic_pendulum}
...
\newcommand{\GreekLettersUsed}{alpha, beta, delta, Delta, theta, mu, pi, rho, Sigma, sigma, phi, omega}
