...
%Latex note: without the \linebreak, latex breaks the line too late, leading to an overfull \hbox.
%Somehow the \linebreak gives it license to put a little more spacesbetween the words without 
%throwing a warning.  --MT
{\tt VideoPoint 2.5}.
