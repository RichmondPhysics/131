...
\begin{figure}[b!]
\centerline{\includegraphics[width=3in]{appendices/excel/excelfigs/excelwindow.eps}}
...
\begin{figure}[b!]
\begin{center}
\includegraphics[height=2.5in]{appendices/excel/excelfigs/histf1.eps}
\hspace{0.4in}
\includegraphics[height=2.5in]{appendices/excel/excelfigs/histf2.eps}
...
\begin{figure}[b!]
\begin{center}
\includegraphics[height=2.5in]{appendices/excel/excelfigs/histf3.eps}\hspace{0.4in}\includegraphics[height=2.5in]{appendices/excel/excelfigs/histf4.eps}
