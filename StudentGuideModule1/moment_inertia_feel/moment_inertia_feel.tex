...
\begin{comment}
This lab is based on an activity I've done in class for several years.  In the past, I've just passed out the sticks and led the class in a discussion about how it feels to spin them with their fingers.  This year, I'll try for the first time to write it as a somewhat structured series of written questions.  We'll see how this works!   --Matt Trawick, 7/2019
