...
gentle collisions between two force probes attached to carts. First, open the \textbf{Two Force Probes 750.cap} application in the \textbf{131 Capstone 750} forder.  Calibrate both force probes 
...
(a) Play a gentle tug-of-war in which you pull the ends of the two force probes away from each other for about 10 seconds with your partner using the hooks on the force probes. What do you observe about the mutual forces?
\vspace{20mm}
