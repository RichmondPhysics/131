...
(see \textit{Calibrating Force Sensors} in \textbf{Appendix F: Instrumentation}). You can strap
...
cart (the target). See \textbf{Appendix E: Video Analysis Using Tracker} for details on making
...
% If using \textbf{VideoPoint}, follow the instructions in \textbf{Appendix D: Video
