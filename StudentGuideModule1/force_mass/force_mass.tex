...
\item \textit{Capstone} software (V, A \& F Graphs)
\end{itemize}
...
(a) Open the \textbf{V, A \& F Graphs 750.cap} application in the \textbf{131 Capstone 750} folder and calibrate the force probe (see \textit{Calibrating Force Sensors} in \textbf{Appendix \ref{capstone}: Capstone}).
\medskip
