...
(a) Open the file \filename{P\_V\_Graphs.cap} in the \filename{\coursefolder} folder. Hang the large spring from the force probe hook with the large diameter coils down and hang a 200-g mass from the spring.  Place the motion detector facing up directly below the spring. Pull the mass straight downward about 10 cm, and let go. 
...
\begin{center}
\includegraphics{periodic_motion/periodic_motion_fig1.eps}
\end{center}
...
\vspace{0.3cm}
\begin{center}
\hspace{0.15in}\includegraphics{periodic_motion/periodic_motion_fig2.eps}
\includegraphics{periodic_motion/periodic_motion_fig3.eps}
\end{center}
...
measured. Use the \button{Delta Tool} to measure position, then subtract the 
