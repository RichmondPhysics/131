...
\[
m_{1}=m_{2}\quad \mbox{and}\quad {{\vec  v}_{1}}=-{{\vec  v}_{2}}\]
...
\[
m_{1}\ll m_{2}\quad \mbox{and}\quad {{\vec  v}_{1}}={{\vec  v}_{2}}\]
...
%\begin{center}
%\includegraphics{newtons_laws/newtons_laws_fig4_new-19-jul-22.eps}
%\end{center}

%\vspace{0.3cm}
{\par\centering \includegraphics{newtons_laws/newtons_laws_fig4_new.eps} \par}
% this fixes a mysterious eps problem with the figure above.
%{\par\centering \includegraphics{newtons_laws/newtons_laws_fig4_new-19-jul-22.eps} \par}
%\vspace{0.3cm}
...
\[
m_{1}>m_{2}\quad \mbox{and}\quad {{\vec  v}_{1}}={{\vec  v}_{2}}=0\]
