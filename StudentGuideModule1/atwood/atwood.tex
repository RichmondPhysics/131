...
\vspace{-0.8cm}
\begin{center}
    \includegraphics[scale = 0.85]{atwood/atwood_fig1.eps}
\end{center}
\end{wrapfigure}
%scale = 0.85,trim={0.5cm, 0.5cm, 2.0cm, 0.5cm},clip
...
\item Capstone software (\filename{Atwood.cap} experiment file)
\end{itemize}
...
4. Open the experiment file \filename{Atwood.cap} in the  \filename{\coursefolder} folder.
