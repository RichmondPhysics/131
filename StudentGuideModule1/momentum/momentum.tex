...
%\vspace{0.3cm}
{\par\centering \includegraphics{momentum/car_and_van.pdf} \par}
...
mass then \( \displaystyle m\frac{d{\vec v}}{dt}=\frac{d\left( m{\vec v}\right) }{dt} \).
Explain why.
\vspace{20mm}

(d) Show that \( \displaystyle \sum {\vec F}=m{\vec a}=\frac{d{\vec p}}{dt} \).
\vspace{20mm}
...
\pagebreak[2]
\vspace{0.3cm}
{\par\centering \includegraphics{momentum/momentum_fig2_new.pdf} \par}
\vspace{0.3cm}
...
%\vspace{0.3cm}
{\par\centering \includegraphics{momentum/hand_and_egg.pdf} \par}
