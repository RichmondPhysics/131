...
(g) Use the \textbf Highlight and \textbf{Statistics} functions to determine the average force and the average acceleration
...
(c) Use the \textbf Highlight and  \textbf{Statistics} functions to find the average force and the average acceleration
and record them below. Find the mean values only during the time interval when
...
If you accelerate the same cart (same mass) with different forces, you will then
have enough data to plot a graph of force \textit{vs.}~acceleration.
