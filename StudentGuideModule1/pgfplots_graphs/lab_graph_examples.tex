...
\end{groupplot}
\makegroupverticals[3]{1,2,3,4,5,6,7,8}

\end{tikzpicture}

(Note in the example just above that the x scale (and the locations of the vertical lines) makes NO sense whatsoever!  I have no idea what the hell is wrong here!  --MT)
