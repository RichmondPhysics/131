...
\instructornote{%
By Matt, added to 131 in 2019.  Time: 50 minutes?

This lab has been used in Modern for many years before 2019.  It assumes students are familiar with the ideas of length contraction and lorentz transforms.  It doesn't give a lot of introduction to the Mathematica simulation, so it probably kind of assumes they've seen that before in previous labs too.  Otherwise, there is no specific introduction necessary for this lab; it is self-contained.
}
