...
\instructornote{%
By Will Hodge, fall 2023.  Updated to use wireless motion sensor. Some of our labs still use the wired sensors. In general, if the apparatus list references the sensor as ``wireless'' (``wireless motion sensor'' or ``wireless force sensor''), it uses the new sensors; otherwise, it does not.
}
