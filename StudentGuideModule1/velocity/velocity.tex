...
To make the graphs in the following activities, use the \textbf{Velocity Graphs} application by going to \textbf{Start} $\rightarrow$ \textbf{Programs} $\rightarrow$ \textbf{Physics Applications} $\rightarrow$ \textbf{131 Capstone 750} $\rightarrow$ \textbf{Velocity Graphs 750.cap}. Click \textbf{Record} to begin, \textbf{Stop} to end a data run.
