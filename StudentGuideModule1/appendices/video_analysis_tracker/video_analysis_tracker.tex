...
Open $Excel$ (in Microsoft Office folder), click on ``HOME'', and click the Paste clipboard. Data should appear in $Excel$. Graph can now be plotted in $Excel$ (see \textbf{Appendix \ref{excel}: Excel}) and printed.
