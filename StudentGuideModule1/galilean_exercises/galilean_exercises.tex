...
Edit these points, and add a third one, to show the last three points in your round-trip journey to the vending machine from part (a).  Divide both $x$ and $t$ by 10 to fit on the graph without having to rescale the axes.  When you are done editing, hit \button{Shift-Enter} to make the changes to the graph.
