...
%---------------------------------------------------------------------------------------------------
%Packages providing general utilities
...
\let\NoExtraPageSection\section %This code line can be used to make each lab start on odd numbered page (right hand side).
