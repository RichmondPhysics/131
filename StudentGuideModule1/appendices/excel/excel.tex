...
\begin{figure}[b!]
\centerline{\includegraphics[width=3in]{../../131/StudentGuideModule1/appendices/excel/excelfigs/excelwindow.pdf}}
...
Then click on the \button{Insert} tab at the top of the window.
In the menu that shows up, there is a section called \button{Charts}.
Almost all of the graphs we make will be scatter plots (meaning plots
with one point for each row of data), so click on the \button{Scatter} icon, 
which is the lower one in the group that looks like this  
\includegraphics[width=0.2in]{../../131/StudentGuideModule1/appendices/excel/excelfigs/scatterplot.pdf}.  
\index{color page}
...
This is done in the \button{Chart Elements} menu which is accessed by clicking 
on the plus sign (+) in a box, at the upper right corner of your graph. Click 
on \button{Axis Titles}, and places appear for axis titles. Edit the text inside 
...
Next, give your graph an overall title. Click on \button{Chart Title} and a box 
...
and select \button{Add Trendline}. A number of options appear such as 
``linear'', ``polynomial'', ``power'', and so on.  Select the one you want, 
and also check the \button{Display Equation on chart} option near the bottom. 
...
\begin{figure}[b!]
\begin{center}
\includegraphics[height=2.5in]{../../131/StudentGuideModule1/appendices/excel/excelfigs/histf1.pdf}
\hspace{0.4in}
\includegraphics[height=2.5in]{../../131/StudentGuideModule1/appendices/excel/excelfigs/histf2.pdf}
...
go to \button{Data} in the menubar, select \button{Sort}, and pick
...
Go to \button{Data} in the menubar, select \button{Data Analysis} (on the right) and 
choose \button{Histogram}. Click \button{OK}.
You should see a dialog box like the one in the right-hand panel of  Figure \ref{hist2}.
Click in the box labeled \button{Input Range} and then highlight the column on the spreadsheet containing your data.
Next, click in the box labeled \button{Bin Range} and highlight the column on the spreadsheet containing the bins.
Under \button{Output Options}, select \button{Chart Output} and click \button{OK}. The histogram should come up. 
If it doesn't, go to \button{Insert} in the menubar and select 
the histogram icon in the \button{Charts} section (the first icon in that section).
...
\begin{figure}[b!]
\begin{center}
\includegraphics[height=2.5in]{../../131/StudentGuideModule1/appendices/excel/excelfigs/histf3.pdf}
\hspace{0.4in}
\includegraphics[height=2.5in]{../../131/StudentGuideModule1/appendices/excel/excelfigs/histf4.pdf}
...
where \( \delta\, \)slope represents the uncertainty in the slope value. You will still need to round off both numbers, depending on the relative magnitudes of the two numbers. It is also common practice to express both numbers to the same power of 10.
